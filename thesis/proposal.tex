...
\newcounter{ndvicount}
\newcommand{\ndvi}{\ifnum\value{ndvicount}=0{\underletter{N}ormalised \underletter{D}ifference \underletter{V}egetation \underletter{I}ndex (NDVI)}\else{NDVI}\fi\stepcounter{ndvicount}}
\newcounter{reddcount}
...
\newcounter{laicount}
\newcommand{\lai}{\ifnum\value{laicount}=0{\underletter{L}eaf \underletter{A}rea \underletter{I}ndex (LAI)}\else{LAI}\fi\stepcounter{laicount}}
\newcounter{evicount}
\newcommand{\evi}{\ifnum\value{evicount}=0{\underletter{E}nhaced \underletter{V}egetation \underletter{I}ndex (EVI)}\else{EVI}\fi\stepcounter{evicount}}
